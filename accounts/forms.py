...
class UserLoginForm(forms.Form):
	...
	password = forms.CharField(label="Password", max_length=30,widget=forms.PasswordInput(attrs={'class':'form-control', 'placeholder':'Enter your password','name':'password'}))
	...
	def clean(self,*args,**kwargs):
		...
		# if user.groups.filter(name='Merchant').exists()==False and user.groups.filter(name='Customer').exists()==False:
...
class MyRegistrationForm(UserCreationForm):
	...
	email = forms.CharField(max_length=75, required=True,widget=forms.TextInput(attrs={'class':'form-control','id':'exampleInputEmail1','placeholder':'Enter your email address','name':'email'}))
